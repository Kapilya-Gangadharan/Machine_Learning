...
axes[0].set(title ='Linear Regression', xlabel = ('Position Level'), ylabel = 'Salary')
#plt.show()

# Visualising the Polynomial Regression results
axes[1].scatter(X, y, color = 'red')
axes[1].plot(X, lin_reg_2.predict(poly_reg.fit_transform(X)), color = 'blue')
axes[1].set(title= 'Polynomial Regression', xlabel = 'Position level', ylabel = 'Salary')
#plt.show()
...
axes[2].set(title = 'Polynomial Regression - Higher Resolution', xlabel=  'Position level', ylabel = 'Salary')
plt.show()
